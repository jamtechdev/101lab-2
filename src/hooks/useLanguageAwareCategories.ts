...
export const LAB_CATEGORY_FALLBACKS: Record<string, Record<string, string>> = {
  ...
  th: {
    'Lab Infrastructure & Essentials': 'โครงสร้างพื้นฐานและอุปกรณ์จำเป็นในห้องปฏิบัติการ',
    'Life Sciences & Biotech': 'วิทยาศาสตร์ชีวภาพและเทคโนโลยีชีวภาพ',
    'Life Sciences & Biotech (Bio)': 'วิทยาศาสตร์ชีวภาพและเทคโนโลยีชีวภาพ',
    'Pharmaceutical & Analytical': 'อุปกรณ์และเครื่องมือเภสัชกรรม',
    'Pharmaceutical & Analytical (Pharma)': 'เภสัชกรรมและการวิเคราะห์',
    'Test & Measurement': 'เครื่องมือวัดและทดสอบในห้องแล็บ',
