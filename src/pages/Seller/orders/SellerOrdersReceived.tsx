...
// Static data for orders received
const staticOrdersReceivedData = {
  active: [
    {
      id: 1,
      order_id: "ORD-001",
    ...
    },
    {
      ...
      order_id: "ORD-002",
      batch_id: "BATCH-007",
      buyer_name: "Eco Plastics Inc",
      buyer_company: "Eco Plastics Inc",
...
const SellerOrdersReceived: React.FC = () => {
    ...
    if (orders.length === 0) {
      return (
        <div className="text-center py-16">
          ...
          <p className="text-muted-foreground text-lg font-medium">No orders received</p>
        </div>
      );
    }
                  ...
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Buyer: {order.buyer_company} ({order.buyer_location}) | Batch: {order.batch_id}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-border/50">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-accent">{order.current_step}</p>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="bg-muted/50 rounded-lg p-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">{order.buyer_company}</p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">{order.buyer_location}</p>
                            </div>
                            <div>
  ...
  const getTabCount = (tab: string) => {
    return staticOrdersReceivedData[tab as keyof typeof staticOrdersReceivedData]?.length || 0;
  };
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">Orders Received from Buyers</h2>
            </div>
          </div>
            ...
            <CardContent className="p-0">
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="active" className="mt-0 p-6">
                  {renderOrdersList(staticOrdersReceivedData.active)}
                </TabsContent>

                <TabsContent value="completed" className="mt-0 p-6">
                  {renderOrdersList(staticOrdersReceivedData.completed)}
                </TabsContent>

                <TabsContent value="cancelled" className="mt-0 p-6">
                  {renderOrdersList(staticOrdersReceivedData.cancelled)}
                </TabsContent>
              </Tabs>
            </CardContent>
          </Card>
