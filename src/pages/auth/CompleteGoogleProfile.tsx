...
import {
  ...
  ArrowLeft, CheckCircle2, AlertCircle, UserPlus,
} from "lucide-react";
              ...
              {step === "form" && (
                <div className="animate-fade-in">
                  <div className="text-center mb-7">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">All fields below are optional — you can skip and fill them later</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      className="w-full h-11 text-sm font-medium text-muted-foreground border-border hover:bg-muted/40"
                      disabled={isSubmitting}
                      onClick={() => submit(true)}
                    >
