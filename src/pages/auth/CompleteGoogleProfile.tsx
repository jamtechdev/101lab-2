    ...
    <div className="min-h-screen overflow-hidden bg-gradient-lab px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-6xl items-center justify-center">
        <div className="grid w-full items-center gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          {/* ── Right card ── */}
          <div className="rounded-3xl bg-card shadow-panel ring-1 ring-border/70">
              ...
              <form onSubmit={submit} className="grid gap-7 sm:grid-cols-2">
                ...
                <label className="block sm:col-span-2">
                  ...
                  <input type="email" value={form.email} readOnly
                    className="h-14 w-full rounded-2xl border border-gray-200 bg-gray-100 px-5 text-sm text-gray-400 cursor-not-allowed focus:outline-none" />
                </label>
                ...
                <label className="block">
                  ...
                  <div className="flex h-14 rounded-2xl border border-gray-200 bg-white focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-100 overflow-hidden">
                    ...
                    <input type="tel" placeholder="+1 555 000 0000" value={form.phone} onChange={setF("phone")}
                      className="flex-1 h-full px-4 text-sm bg-transparent focus:outline-none text-foreground placeholder:text-muted-foreground/55" />
                  </div>
                </label>
                ...
                {/* Password */}
                <label className="block sm:col-span-2">
                  <span className="mb-2 block text-base font-bold text-gray-900">Password <span className="text-muted-foreground font-normal text-sm">(optional)</span></span>
                  <div className="relative">
                  ...
                  <span className="mt-2 block text-sm font-medium text-muted-foreground">At least 8 characters, a capital letter and a special character</span>
                </label>

                {/* Confirm Password */}
                <label className="block sm:col-span-2">
                  <span className="mb-2 block text-base font-bold text-gray-900">Confirm Password</span>
                  <div className="relative">
