...
// ─── Auction Card (Surplex mosaic style — polished) ───────────────────────────
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded overflow-hidden">
        ...
        {/* Bid count — bottom right dark corner */}
          ...
          <div className="relative">
            ...
            {showRight && (
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-9 h-9 rounded-full bg-card border border-border shadow-lg flex items-center justify-center hover:bg-secondary transition-colors"
              >
      ...
      {!isLoading && batches.length > 0 && (
        <div className="relative">
          {showLeft && (
            <button
              onClick={() => scroll("left")}
              className="absolute left-0 top-[90px] -translate-x-4 z-10 w-9 h-9 rounded-full bg-card border border-border shadow-lg flex items-center justify-center hover:bg-secondary transition-colors"
            >
              <ChevronLeft className="h-5 w-5" />
            </button>
          )}
